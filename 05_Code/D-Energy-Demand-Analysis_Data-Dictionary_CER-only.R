...
labels_cer <- list(
  ...
  diff_in.temp_f_65f = "Temperature Difference from 65 Degrees Fahrenheit, Based on Hourly Air Temperatures",
  diff_in.temp_soil_f_65f = "Temperature Difference from 65 Degrees Fahrenheit, Based on Daily Mean 10cm Soil Temperature",
